...
def main():
    base_dir = Path('/home/local/PARTNERS/yz646/Agentic-RL-Scaling-Law/dev/Reasoning360/scripts/tools/data/')
    files = [
    ...
    for rel, split in files:
        inp = base_dir / rel
        out = Path('/home/local/PARTNERS/yz646/Agentic-RL-Scaling-Law/data/guru_verl') / rel
