...
# =================== Data Configuration ===================
OUTPUT_DATA_DIR="/path/to/shared/storage/rlscaledata/data/math_curriculum"
...
TRAIN_FILE="/path/to/your/Agentic-RL-Scaling-Law/data/math_curriculum_sampled/math__sampled_1_100_512.parquet"
...
RESULTS_DIR=/path/to/shared/storage/RLscaleckpt
CHECKPOINT_DIR=${RESULTS_DIR}/checkpoints
mkdir -p ${CHECKPOINT_DIR}      

# =================== Model Configuration ===================
MODEL_NAME=Qwen2.5-7B-Instruct
BASE_MODEL=/path/to/shared/storage/data/model/${MODEL_NAME}

# =================== Logging Configuration ===================
WANDB_PROJECT=agentic_rl_scaling_law

DOMAIN_NAME="math_curriculum_full"
WANDB_EXPERIMENT_NAME=${MODEL_NAME}_${DOMAIN_NAME}_grpo_verl_builtin_CL_100_rerun
