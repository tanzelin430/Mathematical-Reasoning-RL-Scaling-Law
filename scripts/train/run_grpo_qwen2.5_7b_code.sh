...
# =================== Data Configuration ===================
SHARED_DATA_PATH=/fs-computility/mabasic/xuexiangyuan/workspace/agentic-rl-scaling-law/data/guru_verl
...
train_files="['${TRAIN_DATA_DIR}/codegen__leetcode2k_1.3k.parquet','${TRAIN_DATA_DIR}/codegen__livecodebench_440.parquet','${TRAIN_DATA_DIR}/codegen__primeintellect_7.5k.parquet','${TRAIN_DATA_DIR}/codegen__taco_8.8k.parquet']"

# Use medium difficulty as validation (optional, can be set to null)
val_files="['${TRAIN_DATA_DIR}/codegen__leetcode2k_1.3k.parquet','${TRAIN_DATA_DIR}/codegen__livecodebench_440.parquet','${TRAIN_DATA_DIR}/codegen__primeintellect_7.5k.parquet','${TRAIN_DATA_DIR}/codegen__taco_8.8k.parquet']"
...
WANDB_EXPERIMENT_NAME=test_grpo_7b_code
