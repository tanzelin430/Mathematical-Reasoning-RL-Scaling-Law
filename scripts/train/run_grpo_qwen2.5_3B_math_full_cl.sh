...
# Hardware Platform
num_nodes=1
n_gpus_per_node=4  # Default to 8 GPUs
...
actor_seq_multiplier=15  # Actor should be ~2x max sequence length
rollout_seq_multiplier=18
...
# Memory optimization
offload=False
gpu_memory_utilization=0.6  # Reduced from 0.65 for stability with mixed domains
